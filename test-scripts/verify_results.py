...
class TestResultVerifier:
    ...
    def _verify_ignore_rules(self, repo_path):
        ...
        try:
            ...
            has_ignored_files = any(
                any(f.endswith(ext) for ext in ignored_extensions) or
                any(dir_name in f for dir_name in ignored_dirs)
    ...
    def _print_verification_summary(self):
        ...
        print(f"成功率: {successful_scenarios/total_scenarios*100:.1f}%" if total_scenarios > 0 else "0%")
